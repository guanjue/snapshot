...
index_matrix = '/Users/guanjuexiang/Downloads/Snapshot_test/input_data/snapshot_test_run.index.matrix.txt'
...
count_threshold = 2:200#seq(10,200, by=10)
count_ISn_prod = c()
...
count_threshold_max = count_threshold[which.max(count_ISn_prod_1z*count_ISn_prod_2z)]
