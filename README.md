...
## Input data
##### The cell type peak & signal file list: 1st column is the cell type label; 2nd column is the cell-type specific peak bed absolute-file-path; 3rd column is the cell-type specific signal bigWig absolute-file-path; the 4th column is the cell-type specific functional epigenetic state bigBed absolute-file-path.
```
